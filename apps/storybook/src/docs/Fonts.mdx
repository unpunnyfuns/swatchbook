...
import { FontFamilyPreview, FontWeightScale, TokenDetail } from '@unpunnyfuns/swatchbook-blocks';
...
<TokenDetail path="font.family.sans" />

<TokenDetail path="font.weight.bold" />
