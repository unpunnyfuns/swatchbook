...
- **MDX doc pages** put blocks inside prose: a usage guide, a rationale, a migration note. **Stories** put the catalog in the sidebar, add a Controls panel, and bring each view under the same interaction, a11y, and visual-regression runs as your component stories. [Token docs in MDX and stories](/guides/authoring-doc-stories) covers both.
