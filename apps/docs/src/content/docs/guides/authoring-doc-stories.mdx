...
The toolbar still reflects the story's active tuple, so readers see what they're looking at. Any axis you omit falls back to its default. The pin takes priority over the toolbar for that page and reverts when you navigate away.
