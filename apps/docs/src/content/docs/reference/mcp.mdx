...
A [Model Context Protocol](https://modelcontextprotocol.io/) server, `@unpunnyfuns/swatchbook-mcp` exposes a DTCG project's tokens, axes, and diagnostics to AI agents without running Storybook.
...
- [`@unpunnyfuns/swatchbook-core`](/reference/core): the loader this server wraps.
