...
Wrapping a subtree in `ColorFormatContext` overrides this for that subtree; see [`useColorFormat`](/reference/blocks/hooks#usecolorformat) for the full precedence order.
