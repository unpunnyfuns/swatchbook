---
title: Authoring MDX doc pages
slug: "1.0/guides/authoring-doc-stories"
sidebar:
  order: 2
---

# Authoring MDX doc pages
...
For a sidebar catalog of browsable, testable token views instead of prose pages, see [Displaying tokens as stories](/guides/displaying-tokens-as-stories). The two surfaces render the same blocks, and a project can run both.
