...
slug: "1.0/guides/displaying-tokens-as-stories"
sidebar:
  order: 7
---
...
The same blocks render in both surfaces. The [quickstart's "Where to next"](/guides/quickstart#where-to-next) covers when to reach for each: in short, stories for a browsable, testable catalog, [MDX doc pages](/guides/authoring-doc-stories) for blocks wrapped in narrative. A project can run both.
