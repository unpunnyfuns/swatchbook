...
import ThemeConsumptionDiagram from '@site/src/components/diagrams/ThemeConsumptionDiagram';
...
- [Axes reference](../concepts/axes.mdx): the runtime model for tuples and attribute composition.
