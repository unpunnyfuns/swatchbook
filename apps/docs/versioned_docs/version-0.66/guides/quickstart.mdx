...
The [blocks reference](../reference/blocks/index.mdx) has the full prop list for each. The [authoring guide](./authoring-doc-stories.mdx) walks through composing them in real pages.
...
- Embed [doc blocks in MDX stories](./authoring-doc-stories.mdx) to build a proper reference page.
