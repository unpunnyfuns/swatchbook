...
You're reading the right section if you want to **work on swatchbook's code**: fix bugs, add blocks, extend the MCP tool set, rewrite how HMR flows. If you want to *use* swatchbook in your own Storybook, the [Quickstart](../guides/quickstart.mdx) and [Reference](../reference/core.mdx) are the right doors.
