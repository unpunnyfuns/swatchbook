...
The `Project` snapshot passed to `render` carries everything: axes, `tokenGraph`, presets, `defaultTokens`, `resolveAt`, `cssVarPrefix`. See the [Integrations guide](../guides/integrations/index.mdx) for factory usage.
