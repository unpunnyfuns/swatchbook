...
The `Project` snapshot passed to `render` carries everything: axes, themes, presets, resolved maps, `cssVarPrefix`. See the [Integrations guide](../guides/integrations) for factory usage.
