...
The `Project` snapshot passed to `render` carries everything: axes, themes, presets, resolved maps, `cssVarPrefix`. See the [Integrations section](../integrations/) for factory usage.
