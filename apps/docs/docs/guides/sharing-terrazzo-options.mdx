...
import SharedOptionsDiagram from '@site/src/components/diagrams/SharedOptionsDiagram';
...
- [The token pipeline](../concepts/token-pipeline.mdx): how swatchbook's virtual module differs from a file-emitting build.
